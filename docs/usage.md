...
3. [Module Reference](#3-module-reference)
   ...
   - [core/config_manager.py](#32-coreconfig_managerpy)
   - [core/logger.py](#33-coreloggerpy)
   - [core/database.py](#34-coredatabasepy)
   - [core/checkpoint.py](#35-corecheckpointpy)
   - [core/tool_manager.py](#36-coretool_managerpy)
   - [recon/pipeline.py](#37-reconpipelinepy)
   - [recon/ scanner modules](#38-recon-scanner-modules)
   - [intelligence/analyzer.py](#39-intelligenceanalyzerpy)
   - [intelligence/ sub-modules](#310-intelligence-sub-modules)
   - [notifications/dispatcher.py](#311-notificationsdispatcherpy)
   - [monitoring/monitor.py](#312-monitoringmonitorpy)
4. [Exception System](#4-exception-system)
5. [Structured Logging](#5-structured-logging)
6. [Pipeline Workflow](#6-pipeline-workflow)
7. [Intelligence Layer Deep Dive](#7-intelligence-layer-deep-dive)
8. [Attack Plan Output Format](#8-attack-plan-output-format)
